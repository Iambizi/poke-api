              ...
              <div className="card-body">
                <div className="row align-items-center">
                  ...
                  <div className="col-md-9">
                    ...
                    <div className="row align-items-center">
                      <div className="col-12-md-3">HP</div>
                    ...
                    <div className="row align-items-center">
                      <div className="col-12-md-3">Attack</div>
                      <div className="col-12 col-md-9">
                        <div className="progress">
                          <div
                            className="progress-bar"
                    ...
                    <div className="row align-items-center">
                      <div className="col-12-md-3">Defence</div>
                      <div className="col-12 col-md-9">
                        <div className="progress">
                          <div
                            className="progress-bar"
                            role="progressbar"
                            style={{ width: `${this.state.stats.defence}%` }}
                            aria-valuenow="25"
                            aria-valuemin="0"
                            aria-valuemax="100"
                          >
                    ...
                    <div className="row align-items-center">
                      <div className="col-12-md-3">Speed</div>
                      <div className="col-12 col-md-9">
                        <div className="progress">
                          <div
                            className="progress-bar"
                    ...
                    <div className="row align-items-center">
                      <div className="col-12-md-3">Special-attack</div>
                      <div className="col-12 col-md-9">
                        <div className="progress">
                          <div
                            className="progress-bar"
                    ...
                    <div className="row align-items-center">
                      <div className="col-12-md-3">Special-defence</div>
                      <div className="col-12 col-md-9">
                        <div className="progress">
                          <div
                            className="progress-bar"
